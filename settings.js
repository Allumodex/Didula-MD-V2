...
module.exports = {
    SESSION_ID: process.env.SESSION_ID === undefined ? 'PRABATH-MD~YycFxAIC#nJW0QJ8NgLH_hqnX1REWOU-ulgQ3TBJUtRSoRnzZVBs' : process.env.SESSION_ID,
...
HEART_REACT: process.env.HEART_REACT || 'false',
    SUDO: process.env.SUDO === undefined ? '916282524936' : process.env.SUDO,
